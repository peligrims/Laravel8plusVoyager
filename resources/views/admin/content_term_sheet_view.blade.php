<div class="wrapper container-fluid">
	{!! Form::open(['url' => route('term_sheetsview',array('term_sheet'=>$date[id])),'class'=>'form-horizontal','method'=>'POST','enctype'=>'multipart/form-data']) !!}
	...
	<body>
		...
		<p style="padding-left: 52pt;text-indent: 0pt;text-align: left;"> Borrower :{{$date['borrower_id']}} </p>
		<p style="padding-left: 52pt;text-indent: 0pt;text-align: left;">Estimated Value of Asset: {{$date['eva1']}} As Stabilized (to be verified after new appraisal) Loan Amount: {{$date['loan_amount1']}}</p>
		<p style="padding-left: 232pt;text-indent: -180pt;text-align: left;">Use of Funds: {{$date['use_of_funds']}}</p>
		<p style="padding-left: 52pt;text-indent: 0pt;line-height: 13pt;text-align: left;">Maximum LTV: {{$date['max_ltv']}}</p>
		<p style="padding-left: 52pt;text-indent: 0pt;text-align: left;">Term: {{$date['term']}}</p>
		<p style="padding-left: 52pt;text-indent: 0pt;text-align: left;">Interest Rate: {{$date['interest_rate']}}</p>
		<p style="padding-left: 52pt;text-indent: 0pt;text-align: left;">Loan Extension Option: {{$date['loan_ext_option']}}</p>
		<p style="padding-left: 52pt;text-indent: 0pt;text-align: left;">Yield Maintenance:{{$date['yield_maintenance']}}</p>
		<p style="padding-left: 52pt;text-indent: 0pt;line-height: 13pt;text-align: left;">Structure:{{$date['structure']}}</p>
		<p style="padding-left: 52pt;text-indent: 0pt;line-height: 13pt;text-align: left;">Origination Fee: {{$date['original_fee']}}</p>
		<p style="padding-left: 52pt;text-indent: 0pt;line-height: 14pt;text-align: left;">Exit Fee:{{$date['exit_fee']}}
			<span class="s3">L</span>oan
			<span class="s3">A</span>mount, paid to the Lender</p>
		<p style="padding-left: 52pt;text-indent: 0pt;line-height: 13pt;text-align: left;">Broker Fee: {{$date['broker_fee']}}</p>
		<p style="padding-left: 232pt;text-indent: -180pt;text-align: left;">Due Diligence Fee: {{$date['due_diligence_fee']}}
		...
		<p style="text-indent: 0pt;text-align: left;"><br/></p>
				...
				<p class="s6" style="padding-top: 4pt;padding-left: 88pt;text-indent: -18pt;text-align: left;">
		<div class="container">
		...
		@if ($date['lc_02']=='1')
		<li>
		<p>Articles of organization and operating agreement for the holding entity</p>
		</li>
		@else 
		@endif
		...
		@if ($date['lc_03']=='1')
		<li>
			<p>Credit-report authorization form for each guarantor/principal</p>
		</li>
		@else
		@endif
		...
		@if ($date['lc_04']=='1')
		<li>
		<p>Personal financial statement for each guarantor/principal (PFS)</p>
		</li>
		@else
		@endif		
		@if ($date['lc_05']=='1')
		...
		@if ($date['lc_06']=='1')
		<li>
		<p>Guarantor/principal’s resume</p>
		</li>
		@else
		@endif
		...
		@if ($date['lc_07']=='1')
		<li>
		<p>Sponsor(s) global cash flow</p></li>
		@else
		@endif
		</li>
		@if ($date['lc_08']=='1')
